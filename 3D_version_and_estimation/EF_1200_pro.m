...
%2.球面镜1(准直)
PVb1=[52.9280 -152.4000   70.0000];
plot3(0,147.7694,70.0000,'ro');
R1=304.8;%球心与半径
...
%3.光栅
PVg1=[52.9280    2.3510   70.0000];%中心位置
PVg1_axis=[52.9280    2.3510   40.0000];%转轴底部
lx_g1=12.7;ly_g1=12.7;%平铺时的长宽尺寸
zphi_g1=90;ytheta_g1=90; %姿态参数
ytheta_g1_delta=0;%光栅微微倾斜角度
...
for jj=1:size(DVi_set,1)
    ...
    plot3([PVs(1),PVn1(1)],[PVs(2),PVn1(2)],[PVs(3),PVn1(3)], ...
        'Color','k','LineWidth',1,'Marker','.','MarkerSize',12);%入射光线1
...
%     flag_n2=onPlaneMirror(PVn2,PVg1,lx_g1,ly_g1,zphi_g1,ytheta_g1);
    plot3([PVi2(1),PVn2(1)],[PVi2(2),PVn2(2)],[PVi2(3),PVn2(3)], ...
        'Color','k','LineWidth',1,'Marker','.','MarkerSize',12);%入射光线2
    ...
    %         end
            ...
            plot3([PVi4(ii,1),PVn4(ii,1)],[PVi4(ii,2),PVn4(ii,2)],[PVi4(ii,3),PVn4(ii,3)], ...
                'Color',lightcolor,'LineWidth',1,'Marker','.','MarkerSize',12);%入射光线4
        end
    end
end
%----------------------------------------------

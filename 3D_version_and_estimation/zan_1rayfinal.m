...
%1.光源
PVs=[0,0,70];
figure;plot3(PVs(1),PVs(2),PVs(3),'o');
hold on;grid on;axis equal
xlabel('x');ylabel('y');zlabel('z');
%2.入射光线1
DVi1=(rotationmat(83,90)*[0;0;1])';%方向
%3.球面镜1(准直)
...
%5.反射光线1到入射光线2, DVr1-->DVi2,PVn1-->PVi2
...
zphi_g1=91.2;ytheta_g1=90; %姿态参数
%旋转+平移
...
%8.反射光线2到入射光线3,DVr2-->DVi3,PVn2-->PVi3
m=-1;%干涉级次
d=1/300;%300条/mm
lambda=[400e-6 500e-6 600e-6 700e-6]';%列向量
PVr2=grating_reflect(m,d,lambda,PVi2,DVg1,PVn2);%矩阵每行是不同波长对应的反射光线上一点坐标
...
for ii=1:length(lambda)
    ...
    %11.反射光线3到入射光线4,DVr3-->DVi4,PVn3-->PVi4

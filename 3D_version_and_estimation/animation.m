...
%3.光栅
PVg1_0=[52.9280    6.9816   70.0000];%中心位置
...
%误差分析v%
%旋转+平移
[px1_0,py1_0,pz1_0,DVg1_0]=plane_transform(PVg1_0,lx_g1,ly_g1,zphi_g1,ytheta_g1);%正常的情况
%使得光栅微微倾斜
[px1_1,py1_1,pz1_1,DVg1_1,PVg1_1]=axisrot([1,0,0],PVg1_axis,ytheta_g1_delta,px1_0,py1_0,pz1_0,DVg1_0,PVg1_0);
%求出倾斜了的电机旋转轴
motor_DV=cross([1,0,0],DVg1_1);
...
lambda=(6:0.4:13.6)'.*100e-6;
% lambda=(6:0.125:9)'.*100e-6;
...
for idx=1:num
    ...
    set(gcf,'position',[192/3 108/3 192*3 108*3]);
    set(gca,'color','none');
    hold on;grid on;view(-13.9675,21.7288);
    daspect([1 1 1]);axis ([-20 130 0 160 55 85]); 
    set(gca,'position',[0.1,0.1,0.85,0.85]); %后两个是图片占figure的比例
    %
    plot3(PVs(1),PVs(2),PVs(3),'o');
    plot3(PVd1(1),PVd1(2),PVd1(3),'w.','LineWidth',1);
    ...
    %光栅旋转+平移
    AngRot=30+idx/3;
    [px1,py1,pz1,DVg1,PVg1]=axisrot(motor_DV,PVg1_axis,AngRot,px1_1,py1_1,pz1_1,DVg1_1,PVg1_1);
    surf(px1,py1,pz1, ...
        'FaceColor','interp','EdgeColor','none');
    DVg1;

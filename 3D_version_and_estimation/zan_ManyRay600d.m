...
zphi_g1=97;ytheta_g1=90; %姿态参数
d=1/600;%光栅常数,300条/mm
...
%4.球面镜2(会聚)
PVb2=[150,-152.4,70];R2=304.8;%球心与半径
...
for jj=1:size(DVi_set,1)
    ...
    plot3([PVn2(1),PVr2(ii,1)],[PVn2(2),PVr2(ii,2)],[PVn2(3),PVr2(ii,3)], ...
        'Color','k','LineWidth',1,'Marker','.');%入射光线3
    end %debug
...
function [PVgr,theta_i,theta_r]=grating_reflect(m,d,lambda,PVi,DVl,PVl)

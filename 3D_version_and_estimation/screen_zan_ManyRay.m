...
zphi_g1=92.1;ytheta_g1=90; %姿态参数
...
PVd1=[108.017,8.153,70];%中心位置
lx_d1=25;ly_d1=25;%平铺时的长宽尺寸
zphi_d1=282.9;ytheta_d1=90; %姿态参数(根据入射光线4+xyz2ball函数确定)
%旋转+平移
...
sz_i=cosd(THETA_i);
DVi_set=(rotationmat(82.5,90)*[sx_i;sy_i;sz_i])';%旋转
%复色光颜色参数
lambda=[400e-6 500e-6 550e-6 600e-6 700e-6]';%列向量

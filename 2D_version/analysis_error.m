...
kr=0;
%平面镜1
psi=-86;  % 可见光范围83.3-86.8  85.6802
Ax=-80+10;Ay=-53.27; %平面镜左端
length=25;
...
%球面镜2
R2=R;
center2=[50.8-19.1,-105.297];
t2=linspace((-7.1808)/180*pi,(7.1808)*pi/180,21);
...
for i=1:Nn
    ...
    %波长    紫     绿        红
    lambda=[400e-9 600e-9 720e-9]; %j 遍历
%     lambda=[400e-9 475e-9 550e-9 620e-9 740e-9]; %j 遍历
    ...
    if y_c0<=-91 && y_c0>=-120
        [x4,y4,flag]=reflect(x1,y1,x_c0,y_c0,-(x_c0-center2(1))/(y_c0-center2(2)),km2,jm2,74,74,1,lambda_shan);
    end
    ...
    for j=1:numel(lambda)
        ...
        if y_cf1<=-91 && y_cf1>=-120
            [x4,y4,flag]=reflect(x1,y1,x_cf1,y_cf1,-(x_cf1-center2(1))/(y_cf1-center2(2)),km2,jm2,74,74,1,lambda(j));
        end
    end
end
axis equal

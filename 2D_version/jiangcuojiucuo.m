...
%     lambda=[400e-9 475e-9 550e-9 620e-9 740e-9]; %j 遍历
    ...
    [x4,y4,flag]=reflect(x1,y1,x_c0,y_c0,-(x_c0-center2(1))/(y_c0-center2(2)),km2,jm2,24,24,1,lambda_shan);
    ...
    for j=1:numel(lambda)
        ...
        [x4,y4,flag]=reflect(x1,y1,x_cf1,y_cf1,-(x_cf1-center2(1))/(y_cf1-center2(2)),km2,jm2,24,24,1,lambda(j));
    end
end
axis equal
hold off;
